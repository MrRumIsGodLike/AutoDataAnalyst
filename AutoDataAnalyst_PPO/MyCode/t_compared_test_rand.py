...
def t_main_4(data_manager,file_name,data_file_name,plot_data_path,data_dict_file):
    ...
    best = fmin(func, space, algo=rand.suggest, max_evals=1)
...
# if __name__ == '__main__':
    ...
    # data_manager = DataManager()
    # os.mkdir("../validate_time/params_data_rand/digits_rand_" + str(1))
    # os.mkdir("./data_dict/digits_rand_" + str(1))
    # path = "digits_rand_" + str(1)
    ...
    # t_main_4(data_manager, file_name, data_file_name, plot_data_path, data_dict_file)
